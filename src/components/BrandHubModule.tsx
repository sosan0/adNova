  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-4 md:px-0">
        <div>
          <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">Brand Hub</h2>
          <p className="text-slate-500 font-medium text-sm md:text-base">Your brand assets, guidelines, and visual identity in one place.</p>
        </div>
        <button className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-2xl text-sm font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 px-4 md:px-0">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-slate-200 shadow-sm">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <h3 className="text-lg md:text-xl font-black text-slate-900">Color Palette</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {brandColors.map((color) => (
                <div key={color.hex} className="group p-4 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100 hover:border-brand/20 transition-all flex items-center gap-4">
                  <div 
                    className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl shadow-inner flex-shrink-0"
          ...
          <div className="bg-white p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-slate-200 shadow-sm">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <h3 className="text-lg md:text-xl font-black text-slate-900">Typography</h3>
            </div>
            <div className="space-y-4 md:space-y-6">
              {brandFonts.map((font) => (
                <div key={font.name} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100 gap-4">
                  <div className="space-y-1">
                    <p className="text-xl md:text-2xl font-black text-slate-900" style={{ fontFamily: font.name }}>{font.name}</p>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-slate-200 shadow-sm h-full">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              <div className="w-10 h-10 bg-purple-50 text-purple-500 rounded-xl flex items-center justify-center">
                <ImageIcon size={20} />
              </div>
              <h3 className="text-lg md:text-xl font-black text-slate-900">Core Assets</h3>
            </div>
            <div className="space-y-4">
              {brandAssets.map((asset) => (
                <div key={asset.name} className="group p-4 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100 hover:border-brand/20 transition-all">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-sm flex-shrink-0">
            ...
            <div className="mt-8 p-6 bg-brand/5 rounded-2xl md:rounded-3xl border border-brand/10 text-center">
      ...
      <div className="px-4 md:px-0">
        <div className="bg-slate-900 p-6 md:p-10 rounded-[32px] md:rounded-[48px] text-white overflow-hidden relative group">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <h3 className="text-2xl md:text-3xl font-black mb-4 tracking-tight">Brand Voice & Tone</h3>
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                {['Confident', 'Clear', 'Empowering', 'Modern'].map(tag => (
                  <span key={tag} className="px-3 md:px-4 py-1 md:py-1.5 bg-white/10 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-widest border border-white/10">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div className="p-4 md:p-6 bg-white/5 rounded-2xl md:rounded-3xl border border-white/10">
                <p className="text-[10px] md:text-xs font-black text-brand uppercase tracking-widest mb-2">Do's</p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-[11px] md:text-xs text-white/80">
              ...
              <div className="p-4 md:p-6 bg-white/5 rounded-2xl md:rounded-3xl border border-white/10">
                <p className="text-[10px] md:text-xs font-black text-rose-500 uppercase tracking-widest mb-2">Don'ts</p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-[11px] md:text-xs text-white/80">
